ActiveAdmin.register Article do
  ...
  form do |f|
    f.inputs "Edit News" do
      ...
      f.input :calendar, hint: "Example: {{calendar 2015-04-23T08:45 2015-04-23T16:45}} {{agotado}}. Add {{agotado}} only for sold out"
      f.input :second_calendar, hint: "Example: {{calendar 2015-05-23T08:45 2015-05-23T16:45}} {{agotado}}. Add {{agotado}} only for sold out"
